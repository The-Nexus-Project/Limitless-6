...
**View the full changelog for v1.34 [here](https://github.com/The-Nexus-Project/Limitless-6/blob/main/changelogs.md#v1340).**

**Always remember to backup your world(s) before updating!**


**Notable Fixes**
- Fixed **Singularities** having **no recipes** and being **accidentally removed**.
...
**Removed**
- [Wither Skeleton Tweaks](https://www.curseforge.com/minecraft/mc-mods/wither-skeleton-tweaks) (**Nether crashing issues.**)

**Fixes**
- Fixed a **world timeout freeze** issue in **The Nether**.
...
**Changes**
- Blacklisted **Relics** from dropping from **Loot Bundles** to **prevent certain crashes** when opening **Bundles**.
...
**Added**
- [Botanic Additions](https://www.curseforge.com/minecraft/mc-mods/botanic-additions)
...
- [MythicBotany](https://legacy.curseforge.com/minecraft/mc-mods/mythicbotany)
...
**Changes**
- **Additional Chance** for '**@MA Seeds**' in the **Phytogenic Insolator** are now **10%** instead of **1%**.
- Buffed '**@Thermal Series**' **Catalysts** in the **Phytogenic Insolator**.
- **Added** some missing **Guide Books** to the **Eccentric Tome** recipe.
- **Blacklisted** some **items** from the **Loot Bundle loot table**.
- **Modified** the **recipe** for the **Creative Mana Pool**.
- **Modified** the **recipe** for the **Creative Jetpack**.
- **Added** a few **new** loading screen **tips**.
- **Lots** of **new foods** available.
- Some **memory improvements**.
- Some **changes** in **mod updates**, as **always**.


**Fixes**
- A **crash** when **rendering** '**@Joy of Painting**' **"canvas/easel"** **in-world** has been **fixed**.
- A **crash** related to the '**@Relics**' **"Spore Sack"** is now **fixed**.
- Fixed **Mummys** still **spawning** and **causing crashes**.
- Some **issues** with the **Gene Indexer** are now **fixed**.
- Fixed **Creative Energy Cube** being **"uncraftable"**. (**Instructions in End Game Chapter.**)
- Fixed **Creative RF Coil** being **"uncraftable"**. (**Instructions in End Game Chapter.**)
- Fixed a few **recipe conflicts**.
- Some **fixes** in **mod updates**, as **always**.


**Quests**
- Fixed some **completion issues** & **invalid rewards** in the **Productive Bees** chapter.
- **Removed** the **Unwitnessed Amulet** quest **due** to **completion issues**.
- Added **12** new **quests** to the **Botania Chapter**.
...
**Changes**
- **Adjusted** the **recipe** for **Creative Reclamation Chamber**.
- **Removed** the **Glowstone Singularity**.


**Fixes**
- Fixed **missing recipe** for the **Coal Singularity**.
...
**Fixes**
- **Fixed** a **rendering block entity crash**.
...
**Fixes**
- **Fixed** an **easily reproducable** crafting **duplication bug**.
...
**Fixes**
- A **@Snowy Spirit Glow Lights** crash has been **fixed**.
- Fixed a **crash** related to **@Iron Furnaces**.
...
**Fixes**
- **Ticking entit**y & **NoSuchMethodError** crashes have been **fixed**.
...
**Fixes**
- Potential **lag** when **JEI** is **opened** while in **Refined Storage GUIs** has been **resolved**.
- Some **Mining Dimension** issues have been **fixed**.
- Some **fixes** in **mod updates**, as always.


**Quests**
- **Re-Added** a **Chapter**: **Botania**.
- Minor **changes**.
...
**Removed**
- [Corail Adventurer](https://www.curseforge.com/minecraft/mc-mods/corail-adventurer) - (**Caused crashes.**)


**Fixes**
- Fixed a "**Ticking player**" / "**Internal server error**" crash.
...
- [Ok Zoomer](https://www.curseforge.com/minecraft/mc-mods/ok-zoomer-forge)
...
- [Sophisticated Backpacks](https://www.curseforge.com/minecraft/mc-mods/sophisticated-backpacks) (+ [Sophisticated Core](https://www.curseforge.com/minecraft/mc-mods/sophisticated-core))
...
**Changes**
- Added **custom** **ore processing items & blocks** to be used with **mods** later.
- Added **back** the **TNP Food Items** & **Sword** from **previous packs**.
- Added **Compressed Blocks** for common **Minecraft Blocks**.
- Changes in mod updates.


**Fixes**
- Fixed a **recipe conflict** with **@Croptopia - Knife**.
- Various fixes in mod updates.


**Updated**
- **Forge** from version **41.1.22** to **41.1.37**
- All **mods** that could be **updated** have been **updated**.
